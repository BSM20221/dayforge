function EntryCard({ entry, onDeleteEntry, onStartEdit }) {
    ...
    <article className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row justify-end gap-3 pt-2">
        <button
          ...
          className="rounded-xl border border-slate-300 text-slate-700 px-4 py-2 text-sm font-medium hover:bg-slate-100 transition"
        >
          Edit
        </button>
